    ...
    test("Cast Vote") {
        ...
        ergoClient.execute(new java.util.function.Function[BlockchainContext,Unit] {
            override def apply(_ctx: BlockchainContext): Unit = {
                ...
                val proposalBox = proposalContract.box(ctx,0,Array(0L,0L),0L,ctx.createPreHeader().build().getTimestamp()+3600000,-1)
                ...
                val castVoteBox = castVoteContract.box(ctx,voteKey,0,VoteRecord(Array(100L,0L)),dummyAddress).ergoTransactionOutput()
