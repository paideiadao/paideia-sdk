...
/**
  ...
  *
  * @constructor creates a new [[PaideiaContract]] with the specified contract signature.
  * @param _contractSignature the digital signature of the contract
  */
class PaideiaContract(_contractSignature: PaideiaContractSignature) {
  ...
  /**
    ...
    *
    * It is an immutable set containing unique identifiers of all boxes that are neither spent nor in mempool.
    */
  ...
  /**
    ...
    *
    * It is an immutable set containing unique identifiers of boxes that have been spent and are now in mempool.
    */
  ...
  /**
    ...
    *
    * Each input box is identified by a unique identifier which maps to the input box object itself.
    */
  ...
  /**
    ...
    *
    * Reads from file "ergoscript/{Simple Class Name of this contract}/{The version specified in the contract signature}.
    */
  ...
  /**
    * Constants used in the contract code.
    * It stores a collection of key-value pairs representing the different constants.
    */
  ...
  /**
    ...
    *
    * @param boxId the string representation of a box ID.
  ...
  /**
    ...
    *
    * @param box the InputBox instance to be added.
  ...
  /**
    ...
    *
    * @return Set of unspent transaction outputs.
    */
  ...
  /**
    ...
    *
    * @param event Paideia event to handle.
    * @return Paideia event response.
    */
  ...
  /**
    ...
    *
    * @param boxFilter The filter used to select input boxes.
