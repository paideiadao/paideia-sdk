...
/**
  * FilterLeaf is a subclass of FilterNode that implements the matchBox method to check if a given input box matches
  * the specified filter criteria.
  *
  * @param filterType The filter type used for comparison.
  * @param compareValue The value to compare against.
  * @param compareField The field to which the comparison value will be compared.
  * @param listIndex An Integer representing a specific index in a list when compareField is ASSET or REGISTER.
  * @tparam T The type of values being compared (must implement Ordering).
  */
class FilterLeaf[T: Ordering](
  ...
  /**
    * Overrides the matchBox method from its parent class. Returns true if the given box matches the specified
    * filter criteria, false otherwise.
    *
    * @param box The input box to check for a match.
    * @return Boolean that is true if the input box matches the specified filter, false otherwise.
    */
  ...
  /**
    ...
    *
    * @param v1 Object of type T to compare.
    * @param v2 Object of type T to compare.
    * @param ev Required implicitly evidence that T implements Ordered.
    * @return Boolean that is true if v1 > v2, false otherwise.
    */
