...
trait PaideiaBox {
  ...
  /** Converts this output to an input box (used in spending transactions).
    *
    * @param withTxId
    *   The transaction ID to use for the input box.
    * @param withIndex
    *   The index to use for the input box.
    *
    * @return
    *   An InputBoxImpl object that represents this output as an input.
    */
  ...
  /** Creates an OutBox from this transaction output
    *
    * @return
    *   The matching OutBox to represent this transaction output.
    */
  def outBox: OutBox = {
    var b = ctx
  ...
  /** Gets the list of registers of this output.
    *
    * @return
    *   The list of registers for the output.
    */
  ...
  /** Sets the list of registers for this output.
    *
    * @param newRegisters
    *   The new list of registers to set for the output.
    */
  ...
  /** Sets the value of this output.
    *
    * @param newValue
    *   The new value to set for the output.
    */
  ...
  /** Sets the contract of this output.
    *
    * @param newContract
    *   The new contract to set for the output.
    */
  ...
  /** Gets the list of tokens of this output.
    *
    * @return
    *   The list of tokens for the output.
    */
  def tokens = _tokens
  ...
  /** Sets the list of tokens for this output.
    *
    * @param newTokens
    *   The new list of tokens to set for the output.
    */
  ...
  /** Gets the list of context variables of this output.
    *
    * @return
    *   The list of context variables for the output.
    */
  def contextVars = _contextVars

  /** Sets the list of context variables for this output.
    *
    * @param newContextVars
    *   The new list of context variables to set for the output.
    */
  ...
  /** Returns the BlockchainContextImpl instance used by this output.
    *
    * @return
    *   The context instance used by this output.
    */
  def ctx = _ctx
  ...
  /** Updates the BlockchainContextImpl instance used by this output.
    *
    * @param newCtx
    *   The new context instance to be set.
    */
  ...
  /** Returns an ErgoTransactionOutput from the current PaideiaBox's OutBox object.
    ...
    *   the index to use for the input box
    * @return
    *   An instance of ErgoTransactionOutput representing the current output box.
    */
